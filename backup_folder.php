...
$count = $bd->query('SELECT * FROM dossier  WHERE societe !="nmcp" AND societe !="hydro" ORDER BY id ASC');
$maxrow = $count->rowCount();
$reponse = $bd->query('SELECT * FROM dossier WHERE societe !="nmcp" AND societe !="hydro"  ORDER BY id ASC LIMIT '.$i.',1');
