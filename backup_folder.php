...
$count = $bd->query('SELECT * FROM dossier  WHERE mois="10" AND annee="2023" ORDER BY id ASC');
$maxrow = $count->rowCount();
$reponse = $bd->query('SELECT * FROM dossier WHERE  mois="10" AND annee="2023"  ORDER BY id ASC LIMIT '.$i.',1');
