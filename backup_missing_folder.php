    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit bordered">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="<?php echo URLHOST."_pages/_post/creer_miss_dossier_backup.php"; ?>" method="post" id="dossier" name="dossier" class="form-horizontal">
                    <div class="form-body">
                    ...
                    <div>
                        ...
                        <input type="hidden" value="<?php echo $quotation_row; ?>" name="row" id="row" />
                    </div>
