...
$count = $bd->query('SELECT * FROM factures  WHERE societe ="concept" AND societe ="cmg" AND societe = "itech" AND societe = "concerto" AND societe = "agence" GROUP BY num_fact ORDER BY num_fact ASC ');
$maxrow = $count->rowCount();
$reponse = $bd->query('SELECT * FROM factures WHERE societe ="concept" AND societe ="cmg" AND societe = "itech" AND societe = "concerto" AND societe = "agence" GROUP BY num_fact ORDER BY num_fact ASC  LIMIT '.$row.',1');
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue-chambray">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fas fa-file-medical"></i>Migration de  la facture <span style="font-weight: 800; font-style: italic;"><?php echo $donnees["num_fact"]; ?></span></div>
                </div>
