...
$count = $bd->query('SELECT * FROM dossier WHERE societe="concept" OR societe ="concerto" OR societe="agence" OR societe = "itech" AND annee >= 2022 GROUP BY client');
$maxrow = $count->rowCount();


$req = $bd->query('SELECT * FROM dossier WHERE societe="concept" OR societe ="concerto" OR societe="agence" OR societe = "itech"  AND annee >= 2022 GROUP BY client LIMIT '.$i.',1 ');
$recup = $req->fetch();
